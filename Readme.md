...
# Media Server
MEDIA_PORT=8000
MEDIA_HOST=192.168.0.34

# CORS
CORS_ORIGIN=http://localhost:5173
```

> **Catatan:** Ganti `192.168.0.34` dengan IP address komputer Anda. Gunakan `localhost` jika hanya menjalankan di satu mesin.

### 3. Konfigurasi Frontend

Edit file `frontend/src/config.ts`:
```typescript
export const API_URL = "http://192.168.0.34:3000";
```
